        ...
        <div class="row">
          ...
          <div class="span4">
            <aside class="left-sidebar">
              <div class="widget">
               <a class="btn btn-medium btn-theme btn-rounded" href="{{route ('add-article')}}"><i class="icon-plus"></i> Tambah Artikel </a>
              </div>
              <div class="widget">
                ...
                <div class="span8">
                  ...
                  <div class="post-image">
                    <div class="post-heading">
                      <i class="icon-quote-left"></i><h3 style="font: 90 45px/1.3 'Lobster Two';
  color: #2b2b2b;
  text-shadow: 1px 1px 0px #ededed, 2px 2px 0px rgba(0,0,0,0.15);"><a href="#">{{$p ->judul_art}}</a></h3>
                    </div>
                  ...
                  <blockquote>
                    <i class="icon-quote-right"></i> {!! str_limit($p->isi_art,5000) !!}
                  </blockquote>
           ...
           @endforeach
            @endif
            <div class="pagination">{!! $post2->render() !!}</div>
          </div>
        </div>
