...
<head>
  <meta charset="utf-8">
  <title>Mini Project HEXAVARA</title>
...
<link href='http://fonts.googleapis.com/css?family=Lobster+Two' rel='stylesheet' type='text/css'>
  ...
  <!-- fav and touch icons -->  
  <link rel="shortcut icon" href="{{asset('flattern/img/icons.png')}}">  
    ...
    <div class="hidden-top">
      <div class="hidden-top-inner container">
        <div class="row">
          <div class="span12">
            <ul>
              <li><strong>Syavira Tiara Zulkarnain</strong></li><br>
              <li>Informatics ITS</li>
              <li>Find me <i class="icon-envelope-alt"></i> tiarasyavira16@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
