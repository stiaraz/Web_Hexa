      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            ...
            <form method="post" role="form" class="contactForm" action="{{url('add-article')}}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="span12 margintop10 form-group">
                  ...
                  <input type="file" id="input-file-now" class="dropify" name="gambar_art"/> 
                </div>
                <div class="span12 margintop10 form-group">
                ...
                <div class="span12 margintop10 form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Title" data-rule="minlen:4" data-msg="Please enter title" required="" name="judul_art"/>
                  <div class="validation"></div>
                </div>
                <div class="span12 margintop10 form-group">
                  <label class="control-label" for="inputText">  Description</label>
                  <textarea class="form-control" id="summary-ckeditor" name="isi_art"></textarea>
